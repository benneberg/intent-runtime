...
dangerous_areas:
 value:
   ...
   - "Unvalidated Overrides: Direct mutating endpoint (/api/session/facts/override) accepts any inputs without structural sanitization."
 evidence_state: OBSERVED
 confidence: HIGH
 evidence:
...
files_likely_to_change:
 ...
 confidence: HIGH
 evidence:
   - "App.tsx and server.ts have seen recent feature updates"
 notes: ""
...
generated_files:
 ...
 confidence: HIGH
 evidence:
   - "Files created during current prompt execution"
 notes: ""
